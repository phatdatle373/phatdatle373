...
imgLetter.src = ""; //makeupspa-kit-theme-happy-birthday-bunting-paper-banner-party-supply-261454
...
document.querySelector("#mess").addEventListener("change", function() { //chữ màu xanh
